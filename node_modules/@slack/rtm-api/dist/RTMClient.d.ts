...
import { WebClient, WebAPICallResult, RetryOptions, TLSOptions, RTMConnectArguments, RTMStartArguments } from '@slack/web-api';
...
export declare class RTMClient extends EventEmitter {
     ...
     */
    private logger;
    constructor(token: string, { slackApiUrl, logger, logLevel, retryConfig, agent, autoReconnect, useRtmConnect, clientPingTimeout, serverPongTimeout, replyAckOnReconnectTimeout, tls, webClient, }?: RTMClientOptions);
    /**
